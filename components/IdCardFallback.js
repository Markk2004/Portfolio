    ...
    <div className="id-card-fallback-wrap" aria-label={`${profile}, ${role}`}>
      ...
      <div className="id-card-fallback glass-card">
        ...
        <div className="mt-14">
          ...
          <a href={ctaHref} className="mt-8 inline-flex min-h-11 items-center rounded-lg border border-cyan-300/40 px-4 text-xs font-semibold text-cyan-200 transition duration-200 hover:bg-cyan-300/10">Let&apos;s connect</a>
        </div>
